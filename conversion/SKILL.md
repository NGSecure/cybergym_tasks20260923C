...
> **This repo (cybergym_tasks20260923C).** The prime bundles live under
> `cybergym_tasks20260923C/`, and the conversion toolkit is a self-contained copy under
...
From the `cybergym_tasks20260923C/` directory (where the bundles are):

```bash
cd cybergym_tasks20260923C
# one bundle
